...
class SuperAdminElections extends StatefulWidget {
  const SuperAdminElections({Key? key});

  @override
  State<SuperAdminElections> createState() => _SuperAdminElectionsState();
}

class _SuperAdminElectionsState extends State<SuperAdminElections> {
          ...
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (optionText2 != null) {
                  // Extract participants array and get its length
