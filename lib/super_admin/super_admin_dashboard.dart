...
import 'package:votivate/super_admin/super_admin_elections.dart';
import 'package:votivate/super_admin/super_admin_history.dart';
import 'package:votivate/super_admin/super_admin_pending.dart';
import 'package:votivate/super_admin/users_list.dart';
...
class _SuperAdminDashboardState extends State<SuperAdminDashboard> {
  ...
  Future<void> _getUsersCount() async {
    try {
      ...
      setState(() {
        usersCount = querySnapshot.docs.length;
      });
    } catch (e) {
      print('Error getting document count: $e');
    }
  ...
  Future<void> _getHistoryCount() async {
    try {
      QuerySnapshot<Map<String, dynamic>> querySnapshot =
          await FirebaseFirestore.instance.collection('election_history').get();

      setState(() {
        historyCount = querySnapshot.docs.length;
      });
    } catch (e) {
      print('Error getting document count: $e');
    }
  ...
  Future<void> _refresh() async {
    ...
    await _getUsersCount();
    await _getHistoryCount();
    setState(() {
      isLoading = false;
    });
  }
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Divider(height: 1, thickness: 1, color: AppColors.accentColor),
              ...
              GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.policy, color: AppColors.accentColor),
              ...
              GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.assignment, color: AppColors.accentColor),
                      const SizedBox(width: 4),
                      Text(
                        "User Agreement",
                        style: TextStyle(color: AppColors.accentColor),
